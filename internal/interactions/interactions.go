...
var commands = []*discordgo.ApplicationCommand{
	{
		Name: "setup", Description: "setup no-mic channel and its language", Options: []*discordgo.ApplicationCommandOption{
			{Type: discordgo.ApplicationCommandOptionString, Name: "Language", Description: "Language identifier", Required: true},
		},
	},
}
